...
from nst_ai.models.auths import Auths
from nst_ai.models.users import Users
from nst_ai.models.groups import Groups, GroupModel, GroupUpdateForm, GroupForm
...
from nst_ai.constants import ERROR_MESSAGES, WEBHOOK_MESSAGES
...
from nst_ai.utils.misc import parse_duration
from nst_ai.utils.auth import get_password_hash, create_token
from nst_ai.utils.webhook import post_webhook

from nst_ai.env import SRC_LOG_LEVELS, GLOBAL_LOG_LEVEL
...
class OAuthManager:
    ...
    def update_user_groups(self, user, user_data, default_permissions):
        ...
        log.debug(
            f"All groups available in NST-AI: {[g.name for g in all_available_groups]}"
        )
