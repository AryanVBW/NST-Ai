"""OpenTelemetry metrics bootstrap for NST-Ai.
...
from nst_ai.env import OTEL_SERVICE_NAME, OTEL_EXPORTER_OTLP_ENDPOINT

from nst_ai.socket.main import get_active_user_ids
