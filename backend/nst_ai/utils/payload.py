from nst_ai.utils.task import prompt_template, prompt_variables_template
...
def remove_nst_ai_params(params: dict) -> dict:
    """
    Removes NST-AI specific parameters from the provided dictionary.

    Args:
        params (dict): The dictionary containing parameters.

    Returns:
        dict: The modified dictionary with NST-AI parameters removed.
    """
    nst_ai_params = {
...
def apply_model_params_to_body_openai(params: dict, form_data: dict) -> dict:
    params = remove_nst_ai_params(params)
