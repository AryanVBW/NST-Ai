...
from nst_ai.env import SRC_LOG_LEVELS, PIP_OPTIONS, PIP_PACKAGE_INDEX_OPTIONS
from nst_ai.models.functions import Functions
from nst_ai.models.tools import Tools
...
def replace_imports(content):
    ...
    """
    replacements = {
        "from utils": "from nst_ai.utils",
        "from apps": "from nst_ai.apps",
        "from main": "from nst_ai.main",
        "from config": "from nst_ai.config",
    }
